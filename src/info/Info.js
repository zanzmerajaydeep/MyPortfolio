...
export const info = {
    ...
    position: "a Java Full Stack Developer",
    ...
    miniBio: [ // these are just some "tidbits" about yourself. You can look at mine https://paytonjewell.github.io/#/ for an example if you'd like
        ...
        {
            emoji: "📧",
            text: "zanzmerajaydeep5348@gmail.com"
        },
         {
            emoji: "📞",
            text: "+91 7874588173"
    ...
    socials: [
       {
            link: "mailto:zanzmerajaydeep5348@gmail.com",
            icon: "fa fa-envelope",
            label: "gmail"
        }
        ,
        ...
        {
            link: "https://github.com/zanzmerajaydeep",
            icon: "fa fa-github",
            label: 'github'
        },
        {
            link: "https://www.linkedin.com/in/jaydeep-zanzmera-b7a324244",
            icon: "fa fa-linkedin",
            label: 'linkedin'
        },
         {
            link: "ttps://www.instagram.com/zanzmera_jd?igsh=ejNqNjIxb3Y1NDZv",
    ...
    skills:
        {
            ...
            exposedTo: [ 'python', 'Angular','Asp.net','HTML','CSS']
        }
    ,
    hobbies: [
        {
